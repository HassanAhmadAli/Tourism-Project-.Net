...
[ApiController]
public class LocationsController(ApplicationDbContext context, ILogger<LocationsController> logger)
    : ControllerBase
{
    [HttpGet]
    public async Task<ActionResult> GetLocations()
    {
        ...
        catch (Exception e)
        {
            logger.LogError(
                e,
                "An error occurred while fetching locations. The database may not be available."
            );
    ...
    public async Task<IActionResult> PutLocation(int id, UpdateLocationDto updateDto)
    {
        ...
        if (updateDto.NameEnglish != null)
            location.NameEnglish = updateDto.NameEnglish;
        if (updateDto.NameArabic != null)
            location.NameArabic = updateDto.NameArabic;
        if (updateDto.AddressEnglish != null)
            location.AddressEnglish = updateDto.AddressEnglish;
        if (updateDto.AddressArabic != null)
            location.AddressArabic = updateDto.AddressArabic;
        if (updateDto.CityEnglish != null)
            location.CityEnglish = updateDto.CityEnglish;
        if (updateDto.CityArabic != null)
            location.CityArabic = updateDto.CityArabic;
        if (updateDto.CountryEnglish != null)
            location.CountryEnglish = updateDto.CountryEnglish;
        if (updateDto.CountryArabic != null)
            location.CountryArabic = updateDto.CountryArabic;
